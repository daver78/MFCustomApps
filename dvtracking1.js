...
$var1 = "http://davincistage.mindfireis.com/admin/saveConversion2.php?purl=".$pid."&ipaddress=".$_SERVER['HTTP_X_FORWARDED_FOR']."&accountid=". $aid ."&programid=".$DV_CampaignID."&elementname=".$DV_outboundElementID."&visitpage=".$x['path']."&urlParam=".$utmParam."&visittime=".date("Y-m-d").'/'.date("H:i:s");
