...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://studio.afw.mdl.io/api/OutboundApp/AppCallback?serviceTypeId=2019&identifier=". $Identifier."&accountId=". $accountId."&outboundId=0",
