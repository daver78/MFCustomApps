...
require_once '/var/www/html/facebook/php-graph-sdk-5.x/src/Facebook/autoload.php';
...
if (isset($accessToken)) {
	...
	$loginUrl = $helper->getLoginUrl('http://ec2-13-56-79-24.us-west-1.compute.amazonaws.com:8084/facebook/', $permissions);
